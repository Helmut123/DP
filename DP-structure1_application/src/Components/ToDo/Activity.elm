...
import Html.Attributes exposing (class, type_, src, id, href)
...
view model =
    ...
    [
        ...
        [
            ...
            [
                a[ href "/todo", onClick AcitivityDone ][ img [ src "approve.png", id "approve" ][] ]
                , a[ href "/todo", onClick AcitivityRemove ][ img [ src "deny.png", id "deny" ][] ]
            ]
        ]
    ]
