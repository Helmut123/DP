...
init user = 
    case user of
        Nothing ->
            ( Model [] "" 0 [] [] 0 0 0 (Time.millisToPosix 0) False Activity_model.init  Empty "", getTime )
        Just userA ->
            ( Model [] "" 0 [] [] 0 0 0 (Time.millisToPosix 0) False Activity_model.init  Empty userA.username, getTime )
